...
function showSeatDetails(pos) {
    ...
    elPopup.querySelector('.seats-around').innerText = `${countSitsAround(gCinema,pos.i,pos.j).length}`
...
function countSitsAround(mat, rowIdx, colIdx) {
    ...
    for (var i = rowIdx - 1; i <= rowIdx + 1; i++) {
        ...
        for (var j = colIdx - 1; j <= colIdx + 1; j++) {
            ...
            if (cell.isBooked === false) sitsAround.push(1);
        }
    }
